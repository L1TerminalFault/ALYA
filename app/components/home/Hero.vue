  ...
  >
    ...
    >
      <img
        ref="heroBg"
        src="/hero.jpg"
        class="hero-bg-img saturate-200 h-full w-full max-md:origin-right max-md:object-[85%_center] rounded-xl border border-gray-800 object-cover shadow-[inset_0_0_100px_rgba(0,0,0,0.8)]"
      />
