...
<template>
  ...
  >
    ...
    <div
      class="px-5 text-center font-[Haas] text-4xl font-bold tracking-tighter lg:text-7xl"
    >
    ...
    >
      ...
      >
        ...
        <div
          class="mt-2 max-w-xs text-center font-[Switzer] text-xl tracking-widest text-gray-400 uppercase"
        >
          {{ stat.label }}
        </div>
      </div>
